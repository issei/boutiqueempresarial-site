...
**Status**: Implementada ([PR #25](https://github.com/issei/boutiqueempresarial-site/pull/25)) — o passo 2 de §5 (Apps Script) está feito; os passos 1 e 3 (GA4 e Meta) seguem manuais e não verificáveis pelo repositório
